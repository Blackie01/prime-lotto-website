...
const games = [
  {
    title: "Daily Lotto",
    description: "Draws happen every day. Just ₦100 per ticket to stand a chance.",
  ...
  },
  {
    ...
    description: "Test your football knowledge and win big rewards.",
  ...
  },
  {
    ...
    description: "Spin the wheel for instant cash prizes and bonuses.",
  ...
  },
  {
    ...
    description: "Engage with your faith and win amazing rewards daily.",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {games.map((game, idx) => (
            ...
            >
              <div className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${game.color} opacity-50 group-hover:opacity-100 transition-opacity z-10`} />
              ...
              <div className="p-6">
                ...
                <p className="text-white/60 text-sm mb-6 line-clamp-2">{game.description}</p>
