      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 mb-32">
          ...
          >
            <div className="inline-flex items-center gap-2 mb-6">
              <span className="text-[var(--brand-primary)] text-sm font-bold tracking-widest uppercase">
                Daily Lotto
              </span>
            </div>
            ...
            <p className="text-white/60 text-lg mb-8 leading-relaxed">
              Pick 4 numbers per ticket and submit as many as you want. Results
              for the day are announced at midnight. The more tickets you enter,
              the higher your chance of winning big!
            </p>
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-16 mb-32">
          ...
          >
            ...
            <p className="text-white/60 text-lg mb-8 leading-relaxed">
              More of a football fanatic? Flex your brain power with our
              fast-paced trivia. Go through 6 short-timed multiple choice
              questions. If you get all 6 right, you stand a chance of winning
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-16">
          ...
          >
            ...
            <p className="text-white/60 text-lg mb-8 leading-relaxed">
              Choose your specific religion and go through 6 short-timed
              multiple choice questions. Get all 6 right and you stand a chance
              of winning big at the end of the day.
            </p>
